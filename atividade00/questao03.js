...
const valor1 = parseInt(input('Insira o valor do primeiro numero: '))
const valor2 = parseInt(input('Insira o valor do segundo numero: '))
const valor3 = parseInt(input('Insira o valor do terceiro numero: '))
...
(checarMenor)(valor1, valor2, valor3);